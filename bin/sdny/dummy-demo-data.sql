...
INSERT INTO `anonymous_judges` VALUES (2,'(not applicable)',NULL),(3,'(unknown)',NULL),(1,'magistrate',14);
...
CREATE TABLE `defendant_names` (
  ...
  `language_hint` varchar(100) COLLATE utf8_unicode_ci DEFAULT 'Spanish',
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=126199 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping data for table `tmp_event_map`
--

LOCK TABLES `tmp_event_map` WRITE;
/*!40000 ALTER TABLE `tmp_event_map` DISABLE KEYS */;
/*!40000 ALTER TABLE `tmp_event_map` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-09-06 17:18:25
