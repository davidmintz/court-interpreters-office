...
CREATE TABLE languages (id SMALLINT UNSIGNED AUTO_INCREMENT NOT NULL, name VARCHAR(50) NOT NULL, comments VARCHAR(200) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB;
