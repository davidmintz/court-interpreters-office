...
--
-- Host: localhost    Database: test_office
-- ------------------------------------------------------
...
CREATE TABLE `anonymous_judges` (
  ...
  CONSTRAINT `anonymous_judges_ibfk_1` FOREIGN KEY (`default_location_id`) REFERENCES `locations` (`id`) ON DELETE SET NULL
...
CREATE TABLE `clerks_judges` (
  ...
  CONSTRAINT `FK_DB59EF06A76ED395` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  CONSTRAINT `FK_DB59EF06B7D66194` FOREIGN KEY (`judge_id`) REFERENCES `judges` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `event_types` (
  ...
  CONSTRAINT `event_types_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `event_categories` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `locations` (
  ...
  CONSTRAINT `FK_17E64ABA6D6133FE` FOREIGN KEY (`parent_location_id`) REFERENCES `locations` (`id`) ON DELETE CASCADE,
  CONSTRAINT `locations_ibfk_1` FOREIGN KEY (`type_id`) REFERENCES `location_types` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50013 DEFINER=`david`@`localhost` SQL SECURITY DEFINER */
...
-- Dump completed on 2018-04-30 19:28:26
