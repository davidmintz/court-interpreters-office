...
CREATE TABLE languages (id INTEGER NOT NULL, name VARCHAR(50) NOT NULL COLLATE BINARY, comments VARCHAR(300) DEFAULT '' NOT NULL COLLATE BINARY, PRIMARY KEY(id));
...
CREATE TABLE hats (id INTEGER NOT NULL, role_id SMALLINT UNSIGNED DEFAULT NULL, name VARCHAR(50) NOT NULL COLLATE BINARY, anonymity INTEGER UNSIGNED DEFAULT 0 NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_149C3D93D60322AC FOREIGN KEY (role_id) REFERENCES roles (id) NOT DEFERRABLE INITIALLY IMMEDIATE);
...
CREATE TABLE users (id INTEGER NOT NULL, person_id SMALLINT UNSIGNED NOT NULL, role_id SMALLINT UNSIGNED NOT NULL, password VARCHAR(255) NOT NULL, username VARCHAR(50) DEFAULT NULL, active BOOLEAN DEFAULT '0' NOT NULL, last_login DATETIME NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_1483A5E9217BBB47 FOREIGN KEY (person_id) REFERENCES people (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_1483A5E9D60322AC FOREIGN KEY (role_id) REFERENCES roles (id) NOT DEFERRABLE INITIALLY IMMEDIATE);
...
CREATE TABLE roles (id INTEGER NOT NULL, name VARCHAR(40) NOT NULL COLLATE BINARY, PRIMARY KEY(id));
...
CREATE TABLE people (id INTEGER NOT NULL, hat_id SMALLINT UNSIGNED NOT NULL, email VARCHAR(50) DEFAULT NULL COLLATE BINARY, lastname VARCHAR(50) NOT NULL COLLATE BINARY, firstname VARCHAR(50) NOT NULL COLLATE BINARY, middlename VARCHAR(50) DEFAULT '' NOT NULL COLLATE BINARY, office_phone VARCHAR(20) DEFAULT '' NOT NULL COLLATE BINARY, mobile_phone VARCHAR(20) DEFAULT '' NOT NULL COLLATE BINARY, active BOOLEAN NOT NULL, discr VARCHAR(255) NOT NULL COLLATE BINARY, PRIMARY KEY(id), CONSTRAINT FK_28166A268C6A5980 FOREIGN KEY (hat_id) REFERENCES hats (id) NOT DEFERRABLE INITIALLY IMMEDIATE);
...
CREATE TABLE anonymous_judges (id INTEGER NOT NULL, default_location_id SMALLINT UNSIGNED DEFAULT NULL, name VARCHAR(50) NOT NULL COLLATE BINARY, PRIMARY KEY(id), CONSTRAINT FK_5BD10E2D2BE3238 FOREIGN KEY (default_location_id) REFERENCES locations (id) NOT DEFERRABLE INITIALLY IMMEDIATE);
...
CREATE TABLE court_closings (id INTEGER NOT NULL, holiday_id INTEGER DEFAULT NULL, date DATE NOT NULL, description_other VARCHAR(75) DEFAULT NULL COLLATE BINARY, PRIMARY KEY(id), CONSTRAINT FK_F21F4FD1830A3EC0 FOREIGN KEY (holiday_id) REFERENCES holidays (id) NOT DEFERRABLE INITIALLY IMMEDIATE);
...
CREATE TABLE location_types (id INTEGER NOT NULL, type VARCHAR(60) NOT NULL COLLATE BINARY, comments VARCHAR(200) DEFAULT '' NOT NULL COLLATE BINARY, PRIMARY KEY(id));
