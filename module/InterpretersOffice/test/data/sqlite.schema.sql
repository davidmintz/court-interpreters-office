...
CREATE TABLE hats (id INTEGER NOT NULL, role_id SMALLINT UNSIGNED DEFAULT NULL, name VARCHAR(50) NOT NULL COLLATE BINARY, can_be_anonymous BOOLEAN DEFAULT '0' NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_149C3D93D60322AC FOREIGN KEY (role_id) REFERENCES roles (id) NOT DEFERRABLE INITIALLY IMMEDIATE);
