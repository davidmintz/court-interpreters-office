...
CREATE TABLE requests (id INTEGER NOT NULL, language_id SMALLINT UNSIGNED NOT NULL, event_type_id SMALLINT UNSIGNED NOT NULL, judge_id SMALLINT UNSIGNED DEFAULT NULL, anonymous_judge_id SMALLINT UNSIGNED DEFAULT NULL, submitter_id SMALLINT UNSIGNED DEFAULT NULL, location_id SMALLINT UNSIGNED DEFAULT NULL, modified_by_id SMALLINT UNSIGNED DEFAULT NULL, event_id SMALLINT UNSIGNED DEFAULT NULL, date DATE NOT NULL, time TIME NOT NULL, docket VARCHAR(15) DEFAULT '' NOT NULL, created DATETIME NOT NULL, modified DATETIME DEFAULT NULL, comments VARCHAR(600) DEFAULT '' NOT NULL, pending BOOLEAN DEFAULT '1' NOT NULL, cancelled BOOLEAN DEFAULT '0' NOT NULL, extra_json_data VARCHAR(500) DEFAULT '' NOT NULL, PRIMARY KEY(id));
...
CREATE TABLE defendants_requests (request_id SMALLINT UNSIGNED NOT NULL, defendant_id INTEGER UNSIGNED NOT NULL, PRIMARY KEY(request_id, defendant_id));
