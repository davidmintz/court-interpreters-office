...
use Application\Controller\LocationsController;
...
class LocationsControllerTest extends AbstractControllerTest {
    ...
    public function testAddCourtroom()
    {
        ...
        $parent = $em->getRepository('Application\Entity\Location')
                ->findOneBy(['name'=>'500 Pearl']);
        
        $type = $em->getRepository('Application\Entity\LocationType')
        ...
        $courtroom =  $em->getRepository('Application\Entity\Location')
                ->findOneBy(['name'=>'29F']);
    ...
    {
        $em = FixtureManager::getEntityManager();
        $courtroom->setType($em->getRepository('Application\Entity\LocationType')
                ->findOneBy(['type'=>'courtroom']));
        $courtroom->setParentLocation( $em->getRepository('Application\Entity\Location')
                ->findOneBy(['name'=>'500 Pearl']));
